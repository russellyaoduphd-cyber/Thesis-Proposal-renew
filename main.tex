...
PEPs were originally developed by Drori and Teboulle~\cite{drori2014performance} as a systematic framework for studying the
% \todo{Include a citation to Drori and Teboulle here}
...
In our stochastic setting, following the stochastic PEP framework of Rubbens, Colla, and Hendrickx~\cite{rubbens2025computer}, we reformulate the relevant function values,
% \todo{Give credit to Rubben and cite them here.}
